...
|---|---|---|---|---|---|
| **AdBrain** | AI ad creative and Meta lead-generation workflows for local businesses | Next.js, React, TypeScript, Supabase, multi-provider AI, Meta API, Vercel | Brand intake, website autofill, structured creative concepts, validated image/copy variants, Meta campaigns, spend guards, lead sync, audit logs, SSRF-safe fetching, compliance surfaces, token usage ledger and budget routing | Provider availability and cost governance need separate cooldown and budget boundaries | [`adbrain/README.md`](../adbrain/README.md), [`adbrain/docs/ARCHITECTURE.md`](../adbrain/docs/ARCHITECTURE.md) |
| **Tiny Arcade** | Eleven browser games with optional cloud scores and rankings | Vite + TypeScript per game, Supabase, service worker, GitHub Pages | Pure game models, offline shell, account-safe sync, per-mode scores, streaks, ranked leaderboards, 2048, registry parity | Cross-game sync correctness requires registry, storage, cache, lifecycle, and DB invariants together | [`arcade/README.md`](../arcade/README.md), [`arcade/FEATURES.md`](../arcade/FEATURES.md) |
| **ctx** | MCP server that turns GitHub repositories and documentation sites into agent-ready context | Cloudflare Worker, TypeScript, JSON-RPC MCP, Readability/Turndown, custom tar parser | Repo/doc packing, coverage-first ranked passage search, file listing, SSRF-safe crawling, redirect-hop validation, encoded/short-form IPv4 blocking | Security normalization must match the fetch runtime, not only the input syntax; ranking must reward distinct query-term coverage | [`ctx/README.md`](../ctx/README.md), [`ctx/docs/FEATURES.md`](../ctx/docs/FEATURES.md) |
| **mcp** | MCP server for extracting live web pages as clean Markdown | Cloudflare Worker, TypeScript, Readability/Turndown, Streamable HTTP | Markdown extraction, metadata, links, coverage-first ranked page search, SSRF defenses including encoded/short-form IPv4 blocking | Token-efficient web context with a strict network trust boundary and explicit coverage ranking | [`mcp/README.md`](../mcp/README.md), [`mcp/docs/FEATURES.md`](../mcp/docs/FEATURES.md) |
...
| **vbrain** | Public demo of a second-brain engine | Cloudflare Worker, Supabase capture, BM25 search, graph, MCP, static SSG | Search operators and typo tolerance, backlinks, graph view, MCP tools, static SEO export, RSS, section hubs, freshness dates, deep-linkable headings, lineage, capture write-through, dead-link gates | Separate open-source engine from private content; deterministic validation, reference integrity, and release guards | [`vbrain/README.md`](../vbrain/README.md), [`vbrain/site/README.md`](../vbrain/site/README.md) |
